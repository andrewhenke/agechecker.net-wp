...
Tags: age checker, age check, AgeChecker.Net, check age, verify age, age verification, fda, vape, Age Verification and KYC, KYC, Fraud Prevention
...
* Fix error that occured on some setups at checkout relating to "Category Specific API Keys" setting values returning incorrect variable types
